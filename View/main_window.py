...
"background-color: rgb(221, 171, 110);")
        ...
        self.radioButton = QtWidgets.QRadioButton(parent=self.criteria_group_box)
        self.radioButton.setGeometry(QtCore.QRect(10, 80, 231, 20))
        font = QtGui.QFont()
        font.setFamily("Courier New")
        font.setPointSize(24)
        self.radioButton.setFont(font)
        self.radioButton.setAutoFillBackground(False)
        self.radioButton.setStyleSheet("color: rgb(153, 140, 255);\n"
"background-color: rgb(221, 171, 110);")
...
"color: rgb(108, 100, 185);")
    ...
    def retranslateUi(self, main_window):
        ...
        self.radioButton.setText(_translate("main_window", "По убыванию"))
